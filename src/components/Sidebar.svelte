    ...
    <div class="flex-container">
      <div class="profile">
        <img
          class="profile-image"
          src="Josefine.jpg"
          alt="Josefines profile" />
      </div>
      <div class="profile-description">
        <h1>Josefine Schaefer</h1>
        <span class="role">Developer Relations Engineer</span>
        <div class="social">
          <a href="https://twitter.com/JsfnSchfr" target="_blank">
            <svg
          ...
          <a href="https://github.com/josefineschaefer" target="_blank">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="438.549"
              height="438.549"
          ...
          <a href="https://dev.to/josefine">
            <img
              class="icon-img"
              src="https://d2fltix0v2e0sb.cloudfront.net/dev-badge.svg"
              alt="Josefines's DEV Profile" />
          </a>
        </div>
      </div>
    </div>
